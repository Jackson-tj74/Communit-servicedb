...
export const resetPasswordTokenTemplate = (receiverEmail, resetLink,serviceDescription) => {
    return {
        to: receiverEmail,
        subject: `COMMUNITY SERVICES Password Reset`,
        from: `COMMUNITY SERVICES <${process.env.SMTP_GMAIL_SENDER_EMAIL}>`,
        text: 'Hello From COMMUNITY SERVICES, We received a request to reset your password.',
